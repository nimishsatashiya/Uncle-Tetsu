...
class ContactsController extends Controller
{
    ...
    public function __construct() {
        ...
        $this->moduleRouteText = "contacts-inquiry";
        $this->moduleViewName = "admin.contacts_inquiry";
        $this->list_url = route($this->moduleRouteText.".index");

        $module = "Contacts Inquiry";
        $this->module = $module;

        $this->adminAction= new AdminAction;

        $this->modelObj = new GlobalInquiry();  
    ...
    public function index()
    {
        ...
        $data = array();
        $data['page_title'] = "Contacts Inquiry";
    ...
    public function data(Request $request)
    {
       ...
       $model = GlobalInquiry::query();
       return DataTables::eloquent($model)
       ->addColumn('action', function(GlobalInquiry $row) {
