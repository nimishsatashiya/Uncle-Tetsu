...
class FranchisingController extends Controller
{
    ...
    public function __construct() {
        ...
        $this->moduleRouteText = "franchising-inquiry";
        $this->moduleViewName = "admin.franchising_inquiry";
        $this->list_url = route($this->moduleRouteText.".index");

        $module = "Franchising Inquiry";
        $this->module = $module;

        $this->adminAction= new AdminAction;

        $this->modelObj = new FranchisingInquiry();  
    ...
    public function index()
    {
        ...
        $data = array();
        $data['page_title'] = "Franchising Inquiry"; 
    ...
    public function data(Request $request)
    {
       ...
       $model = FranchisingInquiry::query();
       return DataTables::eloquent($model)
       ->addColumn('action', function(FranchisingInquiry $row) {
