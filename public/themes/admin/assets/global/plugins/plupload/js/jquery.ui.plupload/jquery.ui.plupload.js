...
@example
	...
	<script>
		$('#uploader').plupload({
			url : 'http://www.iprore.com/memberportal/upload.php',
			filters : [
				{title : "Image files", extensions : "jpg,gif,png"}
			],
			rename: true,
			sortable: true,
			flash_swf_url : 'http://www.iprore.com/memberportal/http://www.iprore.com/memberportal/js/Moxie.swf',
			silverlight_xap_url : 'http://www.iprore.com/memberportal/http://www.iprore.com/memberportal/js/Moxie.xap',
		});
	</script>
