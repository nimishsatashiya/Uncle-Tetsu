...
| -------------------------------------------------------------------*/
	...
	$editorImagePath = 'http://omuze.com/uploads/plugin/';            
	$config['img_path'] = $editorImagePath; // Relative to domain name
	// echo  $_SERVER['DOCUMENT_ROOT'];exit;

	// $config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR."public_html".DIRECTORY_SEPARATOR."upload".DIRECTORY_SEPARATOR."plugin"; // Physical path. [Usually works fine like this]
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR."uploads".DIRECTORY_SEPARATOR."plugin".DIRECTORY_SEPARATOR; // Physical path. [Usually works fine like this]        
