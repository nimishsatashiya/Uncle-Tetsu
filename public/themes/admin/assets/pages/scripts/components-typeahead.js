var ComponentsTypeahead = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var countries = new Bloodhound({
          ...
          limit: 10,
          prefetch: {
            url: 'http://www.iprore.com/memberportal/demo/typeahead_countries.json',
        ...
        var custom = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          remote: {
            url: 'http://www.iprore.com/memberportal/demo/typeahead_custom.php?query=%QUERY',
            wildcard: '%QUERY'
          }
        });
        ...
        var nba = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: 'http://www.iprore.com/memberportal/demo/typeahead_nba.json'
        });
         
        var nhl = new Bloodhound({
          datumTokenizer: function(d) { return Bloodhound.tokenizers.whitespace(d.team); },
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: 'http://www.iprore.com/memberportal/demo/typeahead_nhl.json'
        });
    ...
    var handleTwitterTypeaheadModal = function() {
        ...
        var custom = new Bloodhound({
          datumTokenizer: function(d) { return d.tokens; },
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          remote: 'http://www.iprore.com/memberportal/demo/typeahead_custom.php?query=%QUERY'
        });
