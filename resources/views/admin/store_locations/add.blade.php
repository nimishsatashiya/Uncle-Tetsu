                    ...
                    {!! Form::model($formObj,['method' => $method,'files' => true, 'route' => [$action_url,$action_params],'class' => 'sky-form form form-group', 'id' => 'main-frm','redirect-url'=>$list_url]) !!}
                        <div class="row ">
                            <div class="col-md-6">
                                ...
                                {!! Form::select('country_id', [''=>'Select Country']+$countriesObj, null, ['class' => 'form-control','data-required' => true]) !!}
                            </div>
                            <div class="col-md-6">
                                <label class="control-label">Shop name:<span class="required">*</span></label>
                                {!! Form::text('shop_name',null,['class' => 'form-control','data-required' => true]) !!}
                             </div>
                            ...
                            <div class="col-md-6">
                                ...
                                {!! Form::text('lat',null,['class' => 'form-control','data-required' => true]) !!}
                             </div>
                             <div class="col-md-6">
                                <label class="control-label">Longitude:<span class="required">*</span></label>
                                {!! Form::text('long',null,['class' => 'form-control','data-required' => true]) !!}
                             </div>
                            <div class="clearfix">&nbsp;</div>
