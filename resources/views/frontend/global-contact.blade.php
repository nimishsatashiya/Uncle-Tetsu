...
<main>
      ...
      <section id="bannerWrap" class="banner-section single-banner">
         ...
         <div class="custom-padding-x">
            <div class="single-img">
               <div class="item">
                  <img class="w-100" src="{{asset('themes/frontend/images/')}}/global-contact.png" alt="">
               </div>
      ...
      <section id="GlobalContact" class="global-contact-page">
         ...
         <div class="common-style">
            ...
            <div class="text-wrap">
               <p><b>NOTE:</b></p>
               <p>＊ If your are interested in Franchising opportunities, please go here to the Franchising page and
                  kindly fill out the form.</p>
               <p>＊ If your are interested in Franchising opportunities, please go here to the Franchising page and
                  kindly fill out the form.</p>
               <p>For all other inquiries, please use the form below, and we will try to get back to you as soon as
                  we
                  can..</p>
            </div>
            ...
            {!! Form::open(['url' => 'contact-form', 'class' => 'custom-form','id' => 'front-form', 'enctype' => 'multipart/form-data']) !!}
               ...
               <div class="form-inline text-group">
                  ...
                  <button type="submit" class="submit-btn">Send <svg xmlns="http://www.w3.org/2000/svg"
